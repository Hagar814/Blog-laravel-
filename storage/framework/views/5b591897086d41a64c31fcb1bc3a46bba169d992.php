<div class="sidebar">
        <nav class="sidebar-nav">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="index.html"><i class="icon-speedometer"></i> <?php echo e(__('word.dashboard')); ?> <span class="tag tag-info">جدید</span></a>
                </li>
                ...
                <li class="nav-title">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('dashboard.settings')); ?>"><i class="icon-people"></i> <?php echo e(trans('word.settings')); ?></a>
    ...
    </div><?php /**PATH C:\xampp\htdocs\youtubeAPP\resources\views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>